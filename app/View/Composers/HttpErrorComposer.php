...
class HttpErrorComposer
{
	...
	protected $http_explanations = array(
    ...
    {
		$name = $this->http_status_codes[$view->exception->getStatusCode()];
		$message = $this->http_explanations[$view->exception->getStatusCode()] ?? "";
        $view->with(['name' => $name, 'message' => $message]);
    }
}